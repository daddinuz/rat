...
#[repr(transparent)]
pub struct Quote(Vec<Word>);

impl FromIterator<Word> for Quote {
    #[inline]
...
impl<const N: usize> From<[Word; N]> for Quote {
    #[inline]
...
impl Quote {
    ...
    #[inline]
    pub fn first_mut(&mut self) -> Option<&mut Word> {
        let Self(inner) = self;
        inner.first_mut()
    }
    ...
    #[inline]
    pub fn last_mut(&mut self) -> Option<&mut Word> {
        let Self(inner) = self;
        inner.last_mut()
    }
    ...
    #[inline]
    pub fn split(&self, index: usize) -> (Quote, Quote) {
        let Self(inner) = self;
    ...
    #[inline]
    pub const fn as_mut_slice(&mut self) -> &mut [Word] {
        let Self(inner) = self;
        inner.as_mut_slice()
    }
...
impl<I: SliceIndex<[Word]>> Index<I> for Quote {
...
impl<I: SliceIndex<[Word]>> IndexMut<I> for Quote {
    #[inline]
...
pub struct Iter<'a> {
    delegate: std::slice::Iter<'a, Word>,
}

impl<'a> Iter<'a> {
    #[inline]
    const fn from_delegate(delegate: std::slice::Iter<'a, Word>) -> Self {
        Self { delegate }
    }
}

impl<'a> Iterator for Iter<'a> {
    type Item = <std::slice::Iter<'a, Word> as Iterator>::Item;
...
pub struct IterMut<'a> {
    delegate: std::slice::IterMut<'a, Word>,
}

impl<'a> IterMut<'a> {
    #[inline]
    const fn from_delegate(delegate: std::slice::IterMut<'a, Word>) -> Self {
        Self { delegate }
    }
}

impl<'a> Iterator for IterMut<'a> {
    type Item = <std::slice::IterMut<'a, Word> as Iterator>::Item;
...
pub struct IntoIter {
    delegate: std::vec::IntoIter<Word>,
}

impl IntoIter {
    #[inline]
    fn from_delegate(delegate: std::vec::IntoIter<Word>) -> Self {
        Self { delegate }
    }
}

impl Iterator for IntoIter {
    type Item = <std::vec::IntoIter<Word> as Iterator>::Item;
...
impl<'a> IntoIterator for &'a Quote {
    type Item = &'a Word;
    type IntoIter = std::slice::Iter<'a, Word>;

    #[inline]
    fn into_iter(self) -> Self::IntoIter {
        let Quote(inner) = self;
        inner.iter()
    }
}

impl<'a> IntoIterator for &'a mut Quote {
